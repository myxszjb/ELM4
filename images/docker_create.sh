...
DOCKER_UP() {
    ...
    if [ ! -f "/elmmb/Dockerfile" ]; then
        wget https://git.xran.link/https://raw.githubusercontent.com/lu0b0/ELM/main/images/Dockerfile -O /elmmb/Dockerfile
    fi
    
    
    wget https://git.xran.link/https://github.com/lu0b0/ELM/releases/download/2.7/elmmb -O /elmmb/elmmb
